...
class S_4_Extension(Scene):
    def construct(self):
        ...
        Double_Cyclic_Group_01_23 = MathTex(r"\mathbb{Q}[\bar{\kappa}_2,\zeta]",
                                            font_size = 15, color = PURPLE).move_to([-6.50, 2.5, 0])
        Double_Cyclic_Group_02_13 = MathTex(r"\mathbb{Q}[\bar{\kappa}_1,\zeta]",
                                            font_size = 15, color = PURPLE).move_to([-5.25, 2.5, 0])
        Double_Cyclic_Group_03_12 = MathTex(r"\mathbb{Q}[\bar{\kappa}_0,\zeta]",
                                            font_size = 15, color = PURPLE).move_to([-4.00, 2.5, 0])
        Cyclic_Group_01           = MathTex(r"\mathbb{Q}[\bar{\ell}_2,\bar{\ell}_3]",
                                            font_size = 15, color = PURPLE).move_to([-2.75, 2.5, 0])
        Cyclic_Group_02           = MathTex(r"\mathbb{Q}[\bar{\ell}_1,\bar{\ell}_3]",
                                            font_size = 15, color = PURPLE).move_to([-2.00, 2.5, 0])
        Cyclic_Group_03           = MathTex(r"\mathbb{Q}[\bar{\ell}_1,\bar{\ell}_2]",
                                            font_size = 15, color = PURPLE).move_to([-1.25, 2.5, 0])
        Cyclic_Group_12           = MathTex(r"\mathbb{Q}[\bar{\ell}_0,\bar{\ell}_3]",
                                            font_size = 15, color = PURPLE).move_to([-0.50, 2.5, 0])
        Cyclic_Group_13           = MathTex(r"\mathbb{Q}[\bar{\ell}_0,\bar{\ell}_2]",
                                            font_size = 15, color = PURPLE).move_to([ 0.25, 2.5, 0])
        Cyclic_Group_23           = MathTex(r"\mathbb{Q}[\bar{\ell}_0,\bar{\ell}_1]",
                                            font_size = 15, color = PURPLE).move_to([ 1.00, 2.5, 0])
        Cyclic_Group_012          = MathTex(r"\mathbb{Q}[\bar{\ell}_3,\zeta]",
                                            font_size = 15, color = PURPLE).move_to([ 2.75, 1.5, 0])
        Cyclic_Group_013          = MathTex(r"\mathbb{Q}[\bar{\ell}_2,\zeta]",
                                            font_size = 15, color = PURPLE).move_to([ 4.00, 1.5, 0])
        Cyclic_Group_023          = MathTex(r"\mathbb{Q}[\bar{\ell}_1,\zeta]",
                                            font_size = 15, color = PURPLE).move_to([ 5.25, 1.5, 0])
        Cyclic_Group_123          = MathTex(r"\mathbb{Q}[\bar{\ell}_0,\zeta]",
        ...
        Klein_4_Group_0 = MathTex(r"\mathbb{Q}[\bar{\kappa}_2]",
                                  font_size = 15, color = PURPLE).move_to([-6.50, 0.5, 0])
        Klein_4_Group_1 = MathTex(r"\mathbb{Q}[\bar{\kappa}_1]",
                                  font_size = 15, color = PURPLE).move_to([-5.25, 0.5, 0])
        Klein_4_Group_2 = MathTex(r"\mathbb{Q}[\bar{\kappa}_0]",
                                  font_size = 15, color = PURPLE).move_to([-4.00, 0.5, 0])
        Klein_4_Group_3 = MathTex(r"\mathbb{Q}[\bar{\kappa}_0^2,\zeta]",
        ...
        Double_Cyclic_Group_01_23_In_Klein_4_Group_3 = Line([-6.50, 2.5-0.1, 0], [ 0.00, 0.5+0.1, 0], color = BLACK, stroke_width = 1.5, buff = 0.0)
        Double_Cyclic_Group_02_13_In_Klein_4_Group_1 = Line([-5.25, 2.5-0.1, 0], [-5.25, 0.5+0.1, 0], color = BLACK, stroke_width = 1.5, buff = 0.0)
        Double_Cyclic_Group_02_13_In_Klein_4_Group_3 = Line([-5.25, 2.5-0.1, 0], [ 0.00, 0.5+0.1, 0], color = BLACK, stroke_width = 1.5, buff = 0.0)
        Double_Cyclic_Group_03_12_In_Klein_4_Group_2 = Line([-4.00, 2.5-0.1, 0], [-4.00, 0.5+0.1, 0], color = BLACK, stroke_width = 1.5, buff = 0.0)
        Double_Cyclic_Group_03_12_In_Klein_4_Group_3 = Line([-4.00, 2.5-0.1, 0], [ 0.00, 0.5+0.1, 0], color = BLACK, stroke_width = 1.5, buff = 0.0)
        ...
        Sym_012 = MathTex(r"\mathbb{Q}[\bar{\ell}_3]",
                          font_size = 15, color = PURPLE).move_to([2.75, -1.5, 0])
        Sym_013 = MathTex(r"\mathbb{Q}[\bar{\ell}_2]",
                          font_size = 15, color = PURPLE).move_to([4.00, -1.5, 0])
        Sym_023 = MathTex(r"\mathbb{Q}[\bar{\ell}_1]",
                          font_size = 15, color = PURPLE).move_to([5.25, -1.5, 0])
        Sym_123 = MathTex(r"\mathbb{Q}[\bar{\ell}_0]",
                          font_size = 15, color = PURPLE).move_to([6.50, -1.5, 0])
        ...
        Cyclic_Group_0213 = MathTex(r"\mathbb{Q}[\sqrt{-3}\bar{\kappa}_2]",
                                    font_size = 15, color = PURPLE).move_to([-5.875, -0.5, 0])
        Cyclic_Group_0123 = MathTex(r"\mathbb{Q}[\sqrt{-3}\bar{\kappa}_1]",
                                    font_size = 15, color = PURPLE).move_to([-4.625, -0.5, 0])
        Cyclic_Group_0132 = MathTex(r"\mathbb{Q}[\sqrt{-3}\bar{\kappa}_0]",
        ...
        Dihedral_Group_0213 = MathTex(r"\mathbb{Q}[\bar{\kappa}_2^2]",
                                      font_size = 15, color = PURPLE).move_to([-5.875, -2.5, 0])
        Dihedral_Group_0123 = MathTex(r"\mathbb{Q}[\bar{\kappa}_1^2]",
                                      font_size = 15, color = PURPLE).move_to([-4.625, -2.5, 0])
        Dihedral_Group_0132 = MathTex(r"\mathbb{Q}[\bar{\kappa}_0^2]",
                                      font_size = 15, color = PURPLE).move_to([-3.375, -2.5, 0])
        Alt_0123            = MathTex(r"\mathbb{Q}[\zeta]",
        ...
        Cyclic_Group_0213_In_Dihedral_Group_0213 = Line([-5.875, -0.5-0.1, 0], [-5.875, -2.5+0.1, 0], color = BLACK, stroke_width = 1.5, buff = 0.0)
        Cyclic_Group_0123_In_Dihedral_Group_0123 = Line([-4.625, -0.5-0.1, 0], [-4.625, -2.5+0.1, 0], color = BLACK, stroke_width = 1.5, buff = 0.0)
        Cyclic_Group_0132_In_Dihedral_Group_0132 = Line([-3.375, -0.5-0.1, 0], [-3.375, -2.5+0.1, 0], color = BLACK, stroke_width = 1.5, buff = 0.0)
        Klein_4_Group_0_In_Dihedral_Group_0213   = Line([-6.50,  0.5-0.1, 0], [-5.875, -2.5+0.1, 0], color = BLACK, stroke_width = 1.5, buff = 0.0)
        Klein_4_Group_1_In_Dihedral_Group_0123   = Line([-5.25,  0.5-0.1, 0], [-4.625, -2.5+0.1, 0], color = BLACK, stroke_width = 1.5, buff = 0.0)
        Klein_4_Group_2_In_Dihedral_Group_0132   = Line([-4.00,  0.5-0.1, 0], [-3.375, -2.5+0.1, 0], color = BLACK, stroke_width = 1.5, buff = 0.0)
        Klein_4_Group_3_In_Dihedral_Group_0213   = Line([ 0.00,  0.5-0.1, 0], [-5.875, -2.5+0.1, 0], color = BLACK, stroke_width = 1.5, buff = 0.0)
        Klein_4_Group_3_In_Dihedral_Group_0123   = Line([ 0.00,  0.5-0.1, 0], [-4.625, -2.5+0.1, 0], color = BLACK, stroke_width = 1.5, buff = 0.0)
        Klein_4_Group_3_In_Dihedral_Group_0132   = Line([ 0.00,  0.5-0.1, 0], [-3.375, -2.5+0.1, 0], color = BLACK, stroke_width = 1.5, buff = 0.0)
        Klein_4_Group_3_In_Alt_0123              = Line([ 0.00,  0.5-0.1, 0], [ 0.000, -2.5+0.1, 0], color =   RED, stroke_width = 1.5, buff = 0.0)
        Sym_0123 = MathTex(r"\mathbb{Q}", font_size = 15, color = PURPLE).move_to([0.0, -3.5, 0.0])
        Dihedral_Group_0213_In_Sym_0123          = Line([-5.875, -2.5-0.1, 0], [ 0.0, -3.5+0.1, 0], color =   RED, stroke_width = 1.5, buff = 0.0)
        Dihedral_Group_0123_In_Sym_0123          = Line([-4.625, -2.5-0.1, 0], [ 0.0, -3.5+0.1, 0], color =   RED, stroke_width = 1.5, buff = 0.0)
        Dihedral_Group_0132_In_Sym_0123          = Line([-3.375, -2.5-0.1, 0], [ 0.0, -3.5+0.1, 0], color =   RED, stroke_width = 1.5, buff = 0.0)
