...
class D_4_Extension(Scene):
    def construct(self):
        ...
        Trivial_Group             = MathTex(r"\mathbb{Q}[\bar{\ell}_0,\mathrm{i}]",
                                            font_size = 30, color = PURPLE).move_to([ 0.0, 3.0, 0])
        Cyclic_Group_02           = MathTex(r"\mathbb{Q}[\bar{\ell}_1]",
                                            font_size = 30, color = PURPLE).move_to([-4.0, 1.0, 0])
        Cyclic_Group_13           = MathTex(r"\mathbb{Q}[\bar{\ell}_0]",
                                            font_size = 30, color = PURPLE).move_to([-2.0, 1.0, 0])
        Double_Cyclic_Group_02_13 = MathTex(r"\mathbb{Q}[\bar{\ell}_0^2,\mathrm{i}]",
                                            font_size = 30, color = PURPLE).move_to([ 0.0, 1.0, 0])
        Double_Cyclic_Group_01_23 = MathTex(r"\mathbb{Q}[\bar{\ell}_0+\bar{\ell}_1]",
                                            font_size = 30, color = PURPLE).move_to([ 2.0, 1.0, 0])
        Double_Cyclic_Group_03_12 = MathTex(r"\mathbb{Q}[\bar{\ell}_0-\bar{\ell}_1]",
                                            font_size = 30, color = PURPLE).move_to([ 4.0, 1.0, 0])
        ...
        Klein_4_Group_0   = MathTex(r"\mathbb{Q}[\bar{\ell}_0^2]",
                                    font_size = 30, color = PURPLE).move_to([-4.0, -1.0, 0])
        Cyclic_Group_0123 = MathTex(r"\mathbb{Q}[\mathrm{i}]",
                                    font_size = 30, color = PURPLE).move_to([ 0.0, -1.0, 0])
        Klein_4_Group_1   = MathTex(r"\mathbb{Q}[\bar{\ell}_0^2\mathrm{i}]",
                                    font_size = 30, color = PURPLE).move_to([ 4.0, -1.0, 0])
        Cyclic_Group_02_In_Klein_4_Group_0             = Line([-4.0, 1.0-0.2, 0], [-4.0, -1.0+0.2, 0], color = BLACK, stroke_width = 1.5, buff = 0.0)
        Cyclic_Group_13_In_Klein_4_Group_0             = Line([-2.0, 1.0-0.2, 0], [-4.0, -1.0+0.2, 0], color = BLACK, stroke_width = 1.5, buff = 0.0)
        Double_Cyclic_Group_02_13_In_Klein_4_Group_0   = Line([ 0.0, 1.0-0.2, 0], [-4.0, -1.0+0.2, 0], color = BLACK, stroke_width = 1.5, buff = 0.0)
        Double_Cyclic_Group_02_13_In_Cyclic_Group_0123 = Line([ 0.0, 1.0-0.2, 0], [ 0.0, -1.0+0.2, 0], color = BLACK, stroke_width = 1.5, buff = 0.0)
        Double_Cyclic_Group_02_13_In_Klein_4_Group_1   = Line([ 0.0, 1.0-0.2, 0], [ 4.0, -1.0+0.2, 0], color = BLACK, stroke_width = 1.5, buff = 0.0)
        Double_Cyclic_Group_01_23_In_Klein_4_Group_1   = Line([ 2.0, 1.0-0.2, 0], [ 4.0, -1.0+0.2, 0], color = BLACK, stroke_width = 1.5, buff = 0.0)
        Double_Cyclic_Group_03_12_In_Klein_4_Group_1   = Line([ 4.0, 1.0-0.2, 0], [ 4.0, -1.0+0.2, 0], color = BLACK, stroke_width = 1.5, buff = 0.0)
        Dihedral_Group_0123 = MathTex(r"\mathbb{Q}",
                                      font_size = 30, color = PURPLE).move_to([ 0.0, -3.0, 0])
        Klein_4_Group_0_In_Dihedral_Group_0123   = Line([-4.0, -1.0-0.2, 0], [0.0, -3.0+0.2, 0], color = BLACK, stroke_width = 1.5, buff = 0.0)
        Cyclic_Group_0123_In_Dihedral_Group_0123 = Line([ 0.0, -1.0-0.2, 0], [0.0, -3.0+0.2, 0], color = BLACK, stroke_width = 1.5, buff = 0.0)
        Klein_4_Group_1_In_Dihedral_Group_0123   = Line([ 4.0, -1.0-0.2, 0], [0.0, -3.0+0.2, 0], color = BLACK, stroke_width = 1.5, buff = 0.0)
