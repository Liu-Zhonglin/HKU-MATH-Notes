...
class S_3_Extension(Scene):
    def construct(self):
        ...
        Trivial_Group    = MathTex(r"\mathbb{Q}[\bar{\kappa}_0,\zeta]",
                                   font_size = 30, color = PURPLE).move_to([ 0.0, 3.0, 0])
        Cyclic_Group_01  = MathTex(r"\mathbb{Q}[\bar{\kappa}_2]",
                                   font_size = 30, color = PURPLE).move_to([-3.0, 0.0, 0])
        Cyclic_Group_02  = MathTex(r"\mathbb{Q}[\bar{\kappa}_1]",
                                   font_size = 30, color = PURPLE).move_to([-1.0, 0.0, 0])
        Cyclic_Group_12  = MathTex(r"\mathbb{Q}[\bar{\kappa}_0]",
                                   font_size = 30, color = PURPLE).move_to([ 1.0, 0.0, 0])
        Cyclic_Group_012 = MathTex(r"\mathbb{Q}[\zeta]",
                                   font_size = 30, color = PURPLE).move_to([ 3.0, 0.0, 0])
