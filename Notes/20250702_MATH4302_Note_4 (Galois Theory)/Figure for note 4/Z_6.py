...
class Z_6(Scene):
    def construct(self):
        ...
        Double_Cyclic_Group_024_135  = MathTex(r"\langle(\bar{\kappa}_0,\bar{\kappa}_2,\bar{\kappa}_4)(\bar{\kappa}_1,\bar{\kappa}_3,\bar{\kappa}_5)\rangle",
                                               font_size = 30, color = PURPLE).move_to([-3.0, 0.0, 0])
        Triple_Cyclic_Group_03_14_25 = MathTex(r"\langle(\bar{\kappa}_0,\bar{\kappa}_3)(\bar{\kappa}_1,\bar{\kappa}_4)(\bar{\kappa}_2,\bar{\kappa}_5)\rangle",
                                               font_size = 30, color = PURPLE).move_to([ 3.0, 0.0, 0])
        ...
        Cyclic_Group_012345 = MathTex(r"\langle(\bar{\kappa}_0,\bar{\kappa}_1,\bar{\kappa}_2,\bar{\kappa}_3,\bar{\kappa}_4,\bar{\kappa}_5)\rangle",
                                      font_size = 30, color = PURPLE).move_to([0.0, -3.0, 0])
